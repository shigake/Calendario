...
namespace Calendario
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Calendario(pascoa.DiaPascoa, ano);
            Console.ReadLine();
        }

       

        private static void Calendario(int pascoa, int ano)
        {
            Imprimir(DiaSemanaUm(pascoa, Bissexto(ano)), Bissexto(ano));
        }

        private static bool Bissexto(int ano)
        {
            int bi = 0;
            if (ano % 100 == 0)
            {
        ...
        private static int DiaSemanaUm(int dia, bool bissexto)
        {
            int diaSemana = 7;
            if (dia > 31)
            {
        ...
        private static void Imprimir(int diaSemanaUm, bool bissexto) {
        ...
        private static int TotalDiaMes(int mes, bool bissexto) {
            switch (mes) {
                case 1: return 31;
        ...
        private static void ImprimeDias(int diaSemana, int dia) {
            if (dia < 10)
            {
        ...
        private static void ImprimeCabecalho(int mes, int diaSemanaUm) {
            switch (mes) {
                case 1:
        ...
        private static void ImprimeFinalMes(int diaSemana) {
            switch (diaSemana)
            {
                case 2:
                    Console.WriteLine(" --  --  --  --  --  --  |");
